...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    ...
    // Strip console.* and debugger from prod bundles. Tile/source events
    // fire hundreds of times per pan, and JSON.stringify on the response
    // object dominates the main thread. Errors and warnings are kept.
    esbuild: isProd ? {
      drop: ['debugger'],
