  ...
  return (
    <>
      <div 
        ...
        onClick={() => window.open('https://planetarycomputer.microsoft.com/catalog', '_blank', 'noopener,noreferrer')}
        title="Navigate to Microsoft Planetary Computer Data Catalog website"
      >
