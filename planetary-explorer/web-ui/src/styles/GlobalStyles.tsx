...
export const GlobalStyles = () => (
  <style>{`
    ...
    * {
    ...
    /* Match the landing-page brand position exactly: pinned to the top-left
       corner at top:4px / left:8px so users see an identical lockup on both
       pages. */
    ...
    /* Tucked into the top-left corner, smaller than the in-app header so
       it reads as a landing-page banner rather than a duplicate header. */
    .landing-top-left {
      position: absolute;
      top: 4px;
      left: 8px;
    ...
    .chat-history-file > div:last-child {
      display: flex;
      align-items: center;
      gap: 4px;
    }
    ...
    .chat-history-session-actions button,
    .chat-history-file button {
      width: 32px;
      height: 32px;
      padding: 0;
    ...
    .chat-history-icon-button:hover,
    .chat-history-session-actions button:hover,
    .chat-history-file button:hover {
      border-color: #cbd5e1;
      background: #fff;
      color: #0f766e;
    }

    .chat-history-icon-button:disabled,
    .chat-history-session-actions button:disabled,
    .chat-history-file button:disabled,
    .chat-history-current-actions button:disabled {
      opacity: 0.48;
      cursor: wait;
    }
    ...
    .chat-history-current-actions button {
      min-width: 0;
      height: 36px;
      padding: 0 10px;
    ...
    .chat-history-current-actions button:hover {
      border-color: #0d9488;
    }
    ...
    .chat-history-file > div:first-child {
      min-width: 0;
      display: flex;
      flex-direction: column;
    }

    .chat-history-file span {
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
      font-size: 12px;
    ...
    .chat-history-session.active {
      border-left-color: #0d9488;
      background: #f0fdfa;
    }

    .chat-history-session-main {
      min-width: 0;
      padding: 4px;
      border: 0;
      background: transparent;
