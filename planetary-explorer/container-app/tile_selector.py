...
"""
Smart Tile Selection System for Planetary Explorer
    ...
    def get_optimal_query_params(
        ...
        if is_optical:
            ...
            if wants_clouds and not wants_clear:
                ...
                # Relaxed when the user pinned a specific narrow window (e.g.,
                # "November 2024"). They've already constrained time, and a
                # strict cloud filter can wipe out cloudy regions/seasons
                # entirely (e.g., Moscow in winter).
                elif user_datetime and "/" in user_datetime and not wants_clear:
                    cloud_threshold = 80
                    logger.info(f"[CLOUD] Narrow user-specified datetime -> relaxed cloud threshold: <{cloud_threshold}%")
