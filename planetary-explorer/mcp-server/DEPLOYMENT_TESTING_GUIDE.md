...
- Deployed MCP Server URL (e.g., `https://planetary-explorer-mcp.azurecontainerapps.io`)
...
# Set variables
$RESOURCE_GROUP = "planetary-explorer-rg"
$ACR_NAME = "planetaryexploreracr"
$IMAGE_NAME = "planetary-explorer-mcp"
$IMAGE_TAG = "latest"
...
az containerapp create `
  ...
  --env-vars `
    "PLANETARY_EXPLORER_BASE_URL=https://your-backend.azurecontainerapps.io" `
...
```powershell
# PowerShell
$MCP_URL = "https://planetary-explorer-mcp.azurecontainerapps.io"
Invoke-WebRequest -Uri "$MCP_URL/" -Method GET | Select-Object -ExpandProperty Content
```

```bash
# Bash/Linux
curl https://planetary-explorer-mcp.azurecontainerapps.io/
```

**Expected Output:**
```json
{
  "service": "Planetary-Explorer MCP Bridge",
  "version": "1.0.0",
  "description": "HTTP bridge to Planetary-Explorer Model Context Protocol server",
  "endpoints": {
    "tools": "/tools/",
    "resources": "/resources/",
    "prompts": "/prompts/",
...
```bash
# Bash/Linux
curl -X POST https://planetary-explorer-mcp.azurecontainerapps.io/resources/read \
...
```bash
# Bash/Linux
curl -X POST https://planetary-explorer-mcp.azurecontainerapps.io/tools/call \
  -H "Content-Type: application/json" \
  -d '{
    "name": "terrain_analysis",
    "arguments": {
...
```python
"""
Test script for deployed Planetary Explorer MCP Server
Run: python test_deployed_mcp.py <YOUR_MCP_URL>
Example: python test_deployed_mcp.py https://planetary-explorer-mcp.azurecontainerapps.io
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python test_deployed_mcp.py https://planetary-explorer-mcp.azurecontainerapps.io")
        sys.exit(1)
    
    mcp_url = sys.argv[1]
    
    print("\n" + "="*70)
    print(" Planetary Explorer MCP Server - Deployment Tests")
    print("="*70)
